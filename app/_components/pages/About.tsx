      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            With a passion for technology and problem-solving, I've embarked on
            an exciting journey in the world of web development. From my first
        ...
        <div className="mt-10">
          <p className="text-lg text-gray-500">
            ...
            ability to bring designs to life. As I delved deeper into the field,
            I discovered my love for back-end technologies and databases, which
